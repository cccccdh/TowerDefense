...
public class Enemy : MonoBehaviour
{
    ...
    private EnemySpawner enemySpawner;  // 적의 삭제를 본인이 하지 않고 EnemySpawner에서 알려서 삭제
    ...
    private IEnumerator OnMove()
    {
        ...
        while (true)
        {
            ...
            // 적의 현재 위치와 목표 위치의 거리가 0.02 * movement2D.MoveSpeed 보다 작을 때 if 조건문 실행
    ...
    {
        // EnemySpawner에서 리스트로 적 정보를 관리하기 때문에 Destroy()를 직접하기않고
